        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://placehold.co https://img.vietqr.io https://*.supabase.co",
              "font-src 'self' data:",
              "connect-src 'self' http://127.0.0.1:54321 http://localhost:54321 https://*.supabase.co https://*.sentry.io https://challenges.cloudflare.com",
